...
public class CSCD212Lab3Test {
	...
	public class TestTeam {
		...
		public class TestTeamMethods {
			...
			@Test
			@DisplayName("properly returns from calculateTaxes")
			public void calculateTaxesWorks() {
				assertEquals(Double.valueOf(269999.73), Double.valueOf(testTeam.calculateTaxes()));
			}
	...
	public class TestPayroll {
		@Test
		@DisplayName("has its BASE_PAYROLL field set to 15000000")
		public void basePayrollIsCorrect() {
			assertEquals(15000000, Payroll.BASE_PAYROLL);
		}
	}

	@Nested
	@DisplayName("A Taxable Interface")
	public class TestTaxable {
		@Test
		@DisplayName("has its BASE_TAX_RATE field set to 0.09")
		public void baseTaxRateIsCorrect() {
			assertEquals(Double.valueOf(0.09), Double.valueOf(Taxable.BASE_TAX_RATE));
		}
	}
